from scraper.scraper_course_vacancy import crawl_course_vacancy
...
def get_course_codes_current_semester():
    ...
    course_codes = CourseTab.objects.filter(
        semesters__contains=current_semester).values_list("course_code", flat=True)
...
if __name__ == "__main__":
    ...
    for course_code in course_code_list:
        course_vacancy = crawl_course_vacancy.get_course_vacancy_by_request(
            course_code)
